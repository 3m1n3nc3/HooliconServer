...
--
-- Table structure for table `x_license`
--

CREATE TABLE `x_license` (
  `id` int(11) NOT NULL,
  `purchase_code` varchar(128) DEFAULT NULL,
  `username` varchar(128) DEFAULT NULL,
  `sslk` varchar(128) DEFAULT NULL,
  `routine_session` int(11) DEFAULT NULL,
  `routine_update` int(11) DEFAULT NULL,
  `proxy_ips` varchar(128) DEFAULT NULL
...
--
-- Indexes for table `x_license`
--
ALTER TABLE `x_license`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `x_license`
--
ALTER TABLE `x_license`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
